...
public:
	...
	void draw(glm::mat4 tileM, glm::mat4 v, int mLoc, int nLoc) const {
...
public:
	...
	void draw(const Map::MinimalPiece * piece, glm::mat4 v, int mLoc, int nLoc, int xpos, int zpos) const {
		// First draw the tile
